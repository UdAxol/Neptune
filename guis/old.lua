...
local getcustomassets = {
	['neptune/assets/old/barlogo.png'] = 'rbxasset://barlogo.png',
	['neptune/assets/old/blatanticon.png'] = 'rbxasset://blatanticon.png',
	['neptune/assets/old/checkbox.png'] = 'rbxasset://checkbox.png',
	['neptune/assets/old/combaticon.png'] = 'rbxasset://combaticon.png',
	['neptune/assets/old/friendsicon.png'] = 'rbxasset://friendsicon.png',
	['neptune/assets/old/guiicon.png'] = 'rbxasset://guiicon.png',
	['neptune/assets/old/info.png'] = 'rbxasset://info.png',
	['neptune/assets/old/pin.png'] = 'rbxasset://pin.png',
	['neptune/assets/old/profilesicon.png'] = 'rbxasset://profilesicon.png',
	['neptune/assets/old/rendericon.png'] = 'rbxasset://rendericon.png',
	['neptune/assets/old/search.png'] = 'rbxasset://search.png',
	['neptune/assets/old/settingsicon.png'] = 'rbxasset://settingsicon.png',
	['neptune/assets/old/targetinfoicon.png'] = 'rbxasset://targetinfoicon.png',
	['neptune/assets/old/textguiicon.png'] = 'rbxasset://textguiicon.png',
	['neptune/assets/old/textv4.png'] = 'rbxasset://textv4.png',
	['neptune/assets/old/textvape.png'] = 'rbxasset://textvape.png',
	['neptune/assets/old/utilityicon.png'] = 'rbxasset://utilityicon.png',
	['neptune/assets/old/vape.png'] = 'rbxassetid://14373395239',
	['neptune/assets/old/worldicon.png'] = 'rbxasset://worldicon.png'
}
	...
	TextList = function(optionsettings, children, api)
		...
		function optionapi:ChangeValue(val)
			...
			for i, v in self.List do
				...
				objectdotin.Image = getcustomasset('neptune/assets/old/checkbox.png')
...
function mainapi:CreateBar()
	...
	logo.Image = getcustomasset('neptune/assets/old/barlogo.png')
	...
	settingsicon.Image = getcustomasset('neptune/assets/old/settingsicon.png')
	...
	searchbutton.ImageLabel.Image = getcustomasset('neptune/assets/old/search.png')
...
function mainapi:CreateOverlay(categorysettings)
	...
	pin.Image = getcustomasset('neptune/assets/old/pin.png')
...
function mainapi:CreateNotification(title, text, duration, type)
	...
	task.delay(0, function()
		...
		iconshadow.ZIndex = 5
		iconshadow.BackgroundTransparency = 1
		iconshadow.Image = getcustomasset('neptune/assets/old/info.png')
		iconshadow.ImageColor3 = Color3.new()
		iconshadow.ImageTransparency = 0.5
...
function mainapi:Load(skipgui, profile)
	...
	if isfile('neptune/profiles/'..game.GameId..'.gui.txt') then
		guidata = loadJson('neptune/profiles/'..game.GameId..'.gui.txt')
		if not guidata then
			guidata = {Categories = {}}
	...
	if isfile('neptune/profiles/'..self.Profile..self.Place..'.txt') then
		local savedata = loadJson('neptune/profiles/'..self.Profile..self.Place..'.txt')
	...
	if inputService.TouchEnabled and #self.Keybind == 1 and self.Keybind[1] == 'RightShift' then
		...
		image.Image = getcustomasset('neptune/assets/old/vape.png')
		image.Parent = button
...
mainapi:CreateCategory({
	Name = 'GUI',
	Icon = getcustomasset('neptune/assets/old/guiicon.png')
})
local combat = mainapi:CreateCategory({
	Name = 'Combat',
	Icon = getcustomasset('neptune/assets/old/combaticon.png')
})
mainapi:CreateCategory({
	Name = 'Blatant',
	Icon = getcustomasset('neptune/assets/old/blatanticon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'Render',
	Icon = getcustomasset('neptune/assets/old/rendericon.png'),
	WindowSize = 196
})
mainapi:CreateCategory({
	Name = 'Utility',
	Icon = getcustomasset('neptune/assets/old/utilityicon.png'),
	WindowSize = 164
})
mainapi:CreateCategory({
	Name = 'World',
	Icon = getcustomasset('neptune/assets/old/worldicon.png')
})
mainapi:CreateCategory({
	Name = 'Inventory',
	Icon = getcustomasset('neptune/assets/old/worldicon.png')
...
local settingspane = mainapi:CreateCategory({
	Name = 'Settings',
	Icon = getcustomasset('neptune/assets/old/settingsicon.png'),
	WindowSize = 166
})
...
local friendssettings = {
	Name = 'Friends',
	Icon = getcustomasset('neptune/assets/old/friendsicon.png'),
...
mainapi:CreateCategoryList({
	Name = 'Profiles',
	Icon = getcustomasset('neptune/assets/old/profilesicon.png'),
...
local textgui = mainapi:CreateOverlay({
	Name = 'Text GUI',
	Icon = getcustomasset('neptune/assets/old/textguiicon.png'),
	WindowSize = 178,
	Function = function()
		mainapi:UpdateTextGUI()
	end
...
VapeLogo.Image = getcustomasset('neptune/assets/old/textvape.png')
...
VapeLogoV4.Image = getcustomasset('neptune/assets/old/textv4.png')
